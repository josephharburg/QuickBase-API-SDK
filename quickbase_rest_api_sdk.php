...
{
    public $user_token     = 'by8hyz_pann_0_z9bnjs7e98yrcpxf6u5drh8znk';    // Valid user token
    public $app_token     = 'd6datj9b2sxqdhnmkyyxcd4ebrv'; //Valid app token. Required.
    public $base_url        = "https://api.quickbase.com/v1"; //The current base url
    public $realm     = 'maximind'; //Quickbase realm string BEFORE .quickbase.com
    ...
    public function create_a_table($add_table_data, $app_id = '')
    {
    ...
    public function update_a_table($update_table_data, $table_id = '', $app_id = '',)
    {
        $endpoint = "/tables/$table_id?appId=$app_id";
    ...
    public function update_or_create_records($values_to_update, $table_id = '', $fields_to_return = array(3))
    {
        $endpoint = "/records";
